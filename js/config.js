...
const CONFIG = {
    ...
    // Your shared folder ID (from the folder URL)
    // Example URL: https://drive.google.com/drive/folders/1dLpwx5dUb4lgj3Bx7H9oLTO2G4qb_sEM
    // Folder ID would be: 1dLpwx5dUb4lgj3Bx7H9oLTO2G4qb_sEM
    googleDriveFolderId: "1dLpwx5dUb4lgj3Bx7H9oLTO2G4qb_sEM",
    
    // API endpoints (do not modify these)
